...
const blokken = [
  ...
  },
  {
    ...
    hero: 'https://images.unsplash.com/photo-1586214096096-eb48f33f374e?w=900&h=600&fit=crop&auto=format',
...
const tripStats = [
  ...
  { icon: Car,      label: 'Camper · Vlucht', sub: 'Vervoer' },
          ...
          <div className="grid sm:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="rounded-2xl overflow-hidden border border-groen/15 bg-white shadow-sm flex flex-col h-full">
              ...
              <div className="bg-groen px-5 py-4">
                <p className="text-[10px] font-semibold text-white/60 uppercase tracking-widest mb-1">29 Dagen</p>
            ...
            <div className="flex flex-col gap-3 h-full">
              ...
              <a
                href="https://www.google.com/maps/dir/San+Carlos+de+Bariloche,Argentina/Puerto+Montt,Chile/Parque+Pumalin,Chile/Puyuhuapi,Chile/Queulat,Chile/Villa+Cerro+Castillo,Chile/El+Chalten,Argentina/Ushuaia,Argentina/Stanley,Falkland+Islands"
                target="_blank"
