...
export const alleReizen: Reis[] = [
  {
    ...
    beschrijving: 'Van de wilde Carretera Austral tot de ongerepte natuur van de Falklands. 25 dagen door het meest spectaculaire landschap op aarde, met camper, daktent en een charter van FIGAS.',
    ...
    dagen: [
      {
        ...
        beschrijving: 'Na een lange vlucht vanuit Amsterdam via Santiago de Chile landen we in Puerto Montt, de poort naar Patagonië. We halen de camper op en bereiden ons voor op veertien dagen pure wildernis.',
        praktisch: [
          { icon: '✈️', label: 'Vlucht', waarde: 'AMS → SCL → PMC' },
          { icon: '🚐', label: 'Camper', waarde: 'Enkele reis, inleveren in Balmaceda op dag 14' },
      ...
      },
      {
        ...
        activiteiten: [
          ...
          'Wildkamperen langs de Río Guillermo',
        ],
      },
      {
        id: 'dag8',
      ...
      },
      {
        ...
        beschrijving: 'Het eerste hoofdstuk sluit af in Balmaceda. We leveren de camper in na dertien dagen Carretera Austral en vliegen naar El Calafate of Río Gallegos, op weg naar Argentinië.',
        praktisch: [
          ...
          { icon: '🌅', label: 'Laatste tip', waarde: 'Vroeg vertrekken zodat je de vlucht ruim haalt' },
        ],
      },
    ],
  },
  ...
  chalten: {
    ...
    dagen: [
      ...
      },
      {
        ...
        beschrijving: 'Een flexibele dag als buffer voor slecht weer, of voor een rustigere wandeling naar Laguna Capri. In de middag vertrekken we richting Ushuaia.',
        activiteiten: [
          'Laguna Capri, een rustiger alternatief van 12 kilometer met prachtig uitzicht',
          'Waterval Chorrillo del Salto via een makkelijke wandeling',
    ...
    dagen: [
      {
        ...
        beschrijving: 'Ushuaia is de zuidelijkste stad ter wereld, gelegen aan het Beaglekanaal. Na aankomst maken we een boottocht over het kanaal langs pinguïns, zeehonden en zeeleeuwen.',
        activiteiten: [
      ...
      },
      {
        ...
        beschrijving: 'Een laatste ochtend in het meest zuidelijke nationale park ter wereld, langs het Beaglekanaal. In de middag vliegen we naar Stanley, waar de Falklandeilanden op ons wachten.',
        activiteiten: [
          ...
          'Inchecken voor de vlucht naar Stanley op de Falklandeilanden',
        ],
      },
    ],
  },
    ...
    dagen: [
      {
        ...
        beschrijving: 'Stanley is de meest geïsoleerde hoofdstad ter wereld, en meteen een van de charmantste. Kleurrijke houten huizen langs de haven, scheepswrakken in de baai en de hartelijkste bewoners die je je kunt wensen.',
        activiteiten: [
      ...
      },
      {
        ...
        beschrijving: 'Het avontuur eindigt waar het begon, in de lucht. Met een charter van FIGAS vliegen we terug naar Stanley, gevolgd door de lange reis naar huis via Santiago de Chile en Amsterdam.',
        praktisch: [
          { icon: '🛩', label: 'FIGAS charter', waarde: 'Sea Lion Island → Stanley' },
          { icon: '✈️', label: 'Vlucht', waarde: 'Stanley → Santiago → Amsterdam' },
          { icon: '💚', label: 'Herinnering', waarde: '25 dagen Patagonië en de Falklands, voor altijd' },
        ],
      },
    ],
  },
