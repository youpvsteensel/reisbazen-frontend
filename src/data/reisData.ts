...
export const alleReizen: Reis[] = [
  {
    ...
    beschrijving: 'Van de wilde Carretera Austral tot de ongerepte natuur van de Falklands. 25 dagen door het meest spectaculaire landschap op aarde, met camper, vluchten en boottochten.',
  ...
  carretera: {
    ...
    dagen: [
      ...
      },
      {
        ...
        beschrijving: 'Het eerste hoofdstuk sluit af in Balmaceda. We leveren de camper in na dertien dagen Carretera Austral en vliegen naar El Calafate, op weg naar Argentinië.',
        praktisch: [
    ...
    dagen: [
      {
        ...
        beschrijving: 'Op dag 21 brengt de wekelijkse LATAM-vlucht vanuit Punta Arenas ons naar Stanley, de meest geïsoleerde hoofdstad ter wereld en meteen een van de charmantste. We hebben twee dagen voor de kleurrijke houten huizen langs de haven, de scheepswrakken in de baai en de hartelijke bewoners.',
        activiteiten: [
