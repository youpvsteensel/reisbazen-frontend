...
export const blokken: Record<string, Blok> = {
  bariloche: {
    ...
    dagBereik: 'Dagen 1–4',
    hero: 'https://images.unsplash.com/photo-1603748849529-bca520039ef8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1600',
    heroCredit: { url: 'https://unsplash.com/photos/vayZXH63Y0s' },
