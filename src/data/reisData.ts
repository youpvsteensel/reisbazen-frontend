  ...
  carretera: {
    ...
    dagen: [
      ...
      },
      {
        ...
        beschrijving: 'Queulat zet wat ons betreft het meest dramatische decor van de hele Carretera neer. De Ventisquero Colgante hangt letterlijk tussen twee bergtoppen, met smeltwater dat in een dunne sluier de diepte in stort. Geen wonder dat dit een van de meest gefotografeerde plekken van Patagonië is.',
        activiteiten: [
      ...
      },
      {
        ...
        beschrijving: 'Vier dagen lang ruilen we de camper in voor de rugzak en lopen we het Cerro Castillo Circuit, zeventig kilometer door een van de spectaculairste maar verrassend stille parken van Patagonië. Langs torenhoge basaltzuilen, turquoise gletsjermeren en pikzwarte rotswanden, met condors die hoog boven ons hun rondjes draaien.',
        activiteiten: [
